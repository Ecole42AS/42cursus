...
urlpatterns = [
    ...
    path('profile/', UserProfileView.as_view(), name='profile'), # ajout de as_view() pour convertir la vue en une vue asynchrone, ce qui permet de l'utiliser dans les URL
