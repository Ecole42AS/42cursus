...
class TestPackageIndex:
        ...
        for v, vc in versions:
            dists = list(
                setuptools.package_index.distros_for_url(
                    'http://example.com/example-foo.zip
                )
            )
    ...
    def test_download_git_with_rev(self, tmp_path, fp):
        url = 'git+https://github.example/group/project@master
        index = setuptools.package_index.PackageIndex()
    ...
    def test_download_git_no_rev(self, tmp_path, fp):
        url = 'git+https://github.example/group/project
        index = setuptools.package_index.PackageIndex()
    ...
    def test_download_svn(self, tmp_path):
        url = 'svn+https://svn.example/project
        index = setuptools.package_index.PackageIndex()
...
class TestContentCheckers:
    ...
    def test_blank_md5(self):
        ...
        checker = setuptools.package_index.HashChecker.from_url('http://foo/bar
        checker.feed('anything'.encode('ascii'))
        assert checker.is_valid()
