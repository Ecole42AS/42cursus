...
class ListCommands(CommandsProtocol):
    ...
    see: https://redis.io/topics/data-types
    """
...
class GearsCommands:
    def tfunction_load(
        ...
        https://github.com/RedisGears/RedisGears/blob/master/docs/function_advance_topics.md
    ...
    def tfunction_list(
        ...
        ``lib_name`` specifying a library name (can be used multiple times to show multiple libraries in a single command) 
