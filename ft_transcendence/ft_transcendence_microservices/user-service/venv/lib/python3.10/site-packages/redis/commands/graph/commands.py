...
class GraphCommands:
    ...
    def query(self, q, params=None, timeout=None, read_only=False, profile=False):
        ...
        For more information see `GRAPH.QUERY <https://redis.io/commands/graph.query>`_. 
    ...
    def delete(self):
        """
        Deletes graph.
        For more information see `DELETE <https://redis.io/commands/graph.delete>`_. 
        """
        self._clear_schema()
    ...
    def profile(self, query):
        ...
        spent in each operation.
        For more information see `GRAPH.PROFILE <https://redis.io/commands/graph.profile>`_. 
        """
    ...
    def slowlog(self):
        ...
        For more information see `GRAPH.SLOWLOG <https://redis.io/commands/graph.slowlog>`_. 
    ...
    def list_keys(self):
        ...
        For more information see `GRAPH.LIST <https://redis.io/commands/graph.list>`_. 
        """
    ...
    def explain(self, query, params=None):
        ...
        For more information see `GRAPH.EXPLAIN <https://redis.io/commands/graph.explain>`_. 
...
class AsyncGraphCommands(GraphCommands):
    async def query(self, q, params=None, timeout=None, read_only=False, profile=False):
        """
        Executes a query against the graph.
        For more information see `GRAPH.QUERY <https://oss.redis.com/redisgraph/master/commands/
