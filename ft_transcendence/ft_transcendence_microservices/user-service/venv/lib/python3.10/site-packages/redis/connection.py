...
class SSLConnection(Connection):
    ...
    use of ssl.SSLContext (https://docs.python.org/3/library/ssl.html
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            ssl_ciphers: A string listing the ciphers that are allowed to be used. Defaults to None, which means that the default ciphers are used. See https://docs.python.org/3/library/ssl.html
