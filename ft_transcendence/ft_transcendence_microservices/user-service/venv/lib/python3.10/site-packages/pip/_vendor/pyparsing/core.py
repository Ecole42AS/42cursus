...
class __compat__(__config_flags):
    ...
    - ``collect_all_And_tokens`` - flag to enable fix for Issue
...
class Literal(Token):
    ...
    Example::
        ...
        Literal('blah').parse_string('blah')
        Literal('blah').parse_string('blahfooblah')
        Literal('blah').parse_string('bla')
...
class CharsNotIn(Token):
    ...
    Example::
        ...
        print(delimited_list(csv_value).parse_string("dkls,lsdkjf,s12 34,@!
...
class OneOrMore(_MultipleMatch):
    ...
    Example::
        ...
        OneOrMore(attr_expr).parse_string(text).pprint()
